...
import { FaGithub, FaLinkedin, FaEnvelope, FaCopy, FaArrowUp, FaArrowDown, FaExternalLinkAlt, FaSun, FaMoon } from "react-icons/fa";
...
export default function App() {
  ...
  const projects = [
    {
      ...
      tags: ["React.js", "Node.js", "Express", "Gemini 2.0 Flash API", "Code Editor", "Markdown"],
    ...
    },
    {
      ...
      tags: ["Node.js", "Express.js", "MongoDB", "Mongoose", "JWT", "bcrypt.js", "Multer", "REST API"],
      link: "https://github.com/Bhargav-sunil/multivendor-ecommerce-backend",
      demo: null
    },
    {
      id: 3,
      ...
      tags: ["React.js", "React Router", "Node.js", "Express.js", "SQLite3", "JWT", "bcryptjs"],
  ...
  // Enhanced email copy functionality with mobile support
  function copyEmail() {
  ...
  // Enhanced smooth scroll to section with mobile support
  ...
  useEffect(() => {
    const handleScroll = () => {
      ...
      setShowScrollBottom(scrolled > 100 && scrolled + windowHeight < documentHeight - 100);
    };
  ...
  return (
    <div className={`min-h-screen min-w-full transition-colors duration-300 ${
      darkMode 
      ...
      {/* Header */}
      <header className={`w-full backdrop-blur-lg border-b sticky top-0 z-30 transition-all duration-300 ${
        darkMode 
        ...
        {/* Mobile menu */}
        {mobileOpen && (
          <div className={`md:hidden backdrop-blur-lg border-t animate-fade-in ${
      ...
      <main id="main" className="flex-1 w-full">
        ...
        >
          ...
          <div className={`absolute top-10 left-10 w-72 h-72 rounded-full blur-3xl animate-float ${
            darkMode ? 'bg-purple-900/20' : 'bg-purple-300/20'
          }`} />
          <div className={`absolute bottom-10 right-10 w-96 h-96 rounded-full blur-3xl animate-float-delayed ${
          ...
          <div className="max-w-7xl mx-auto w-full px-6 py-12 flex flex-col-reverse md:flex-row items-center gap-12 lg:gap-20">
            <div className="w-full md:w-1/2 space-y-6">
              ...
              <p className={`text-lg sm:text-xl lg:text-2xl max-w-3xl leading-relaxed ${
              ...
              <div className="flex flex-wrap gap-4 pt-4">
                ...
                <button
                  onClick={() => {
                    window.location.href = `mailto:${profile.email}?subject=Contact%20from%20Portfolio&body=Hello%20${profile.name},`;
                  }}
              ...
              <div className={`flex flex-wrap gap-6 pt-6 text-sm ${
                ...
                <div className="flex items-center gap-2">
                  ...
                  <span><strong className="font-semibold">Location:</strong> {profile.location}</span>
                </div>
                <div className="flex items-center gap-2">
                  <div className="w-2 h-2 bg-blue-500 rounded-full animate-pulse" />
                  <span><strong className="font-semibold">Experience:</strong> Fresher</span>
                </div>
              </div>
            </div>
            ...
            <div className="w-full md:w-1/2 flex justify-center">
              <div className="relative group">
                ...
                <div className={`relative w-80 h-80 rounded-2xl p-8 shadow-2xl flex flex-col items-center justify-center transform group-hover:scale-105 transition-all duration-500 ${
        ...
        <section id="about" className="py-20 max-w-7xl mx-auto px-6">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <p className={`text-lg leading-relaxed ${
              ...
              I'm a passionate Full Stack Developer fresh in the field with strong expertise in MERN stack development. 
              I've built multiple projects showcasing my ability to create complete web applications from frontend to backend. 
              I'm dedicated to writing clean, maintainable code and creating seamless user experiences. 
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-8">
            {filtered.map((project) => (
              ...
              >
                <h3 className={`text-xl font-bold mb-3 group-hover:text-indigo-600 transition-colors ${
                  ...
                  >
                    {project.title}
                    <FaExternalLinkAlt size={14} className={darkMode ? 'text-gray-500' : 'text-gray-400'} />
                  </a>
                </h3>
            ...
            {filtered.length === 0 && (
              <div className={`col-span-full text-center py-12 ${
                ...
                <p className="mt-2">Try different keywords or browse all projects.</p>
              </div>
            )}
          </div>
        </section>
        ...
        <section id="contact" className={`py-20 backdrop-blur-sm ${
          ...
          <div className="max-w-7xl mx-auto px-6">
            ...
            <p className={`text-lg text-center max-w-3xl mx-auto mb-12 ${
              ...
              Interested in working together or have a question? Reach out — I typically reply within a few business days.
            </p>

            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 max-w-6xl mx-auto">
              {/* Contact Info Box - Combined Email & Social */}
              <div className={`rounded-2xl p-8 shadow-lg border transform hover:scale-105 transition-all duration-300 flex flex-col ${
                ...
                <div>
                  ...
                  <div className="space-y-3">
                    ...
                    >
                      ...
                      <FaExternalLinkAlt size={12} className={darkMode ? 'text-gray-400' : 'text-gray-500'} />
                    </a>
                    <a
                      href={profile.linkedin}
                      target="_blank"
              ...
              {/* Contact Form Box */}
              <div className={`rounded-2xl p-8 shadow-lg border transform hover:scale-105 transition-all duration-300 ${
                darkMode ? 'bg-gray-800 border-gray-700' : 'bg-white border-gray-100'
              }`}>
            ...
            <div className="flex flex-col md:flex-row items-center justify-between gap-6">
              ...
              <div className="flex gap-4">
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className={darkMode ? 'text-gray-400 hover:text-indigo-400' : 'text-gray-400 hover:text-indigo-600'}
                >
                  <FaGithub size={20} />
                </a>
                <a
